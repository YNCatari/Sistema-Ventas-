...
FOREIGN KEY (FCodigoEmpleado) REFERENCES tbEmpleado (Codigo)
go

 ALTER TABLE tbBoleta
ADD CONSTRAINT FK_Boleta_Cliente
FOREIGN KEY (FDniCliente) REFERENCES tbCliente (Dni)
go

 ALTER TABLE tbDetalle
ADD CONSTRAINT FK_detalle_Boleta
FOREIGN KEY (Serie,numero) REFERENCES tbBoleta (Serie,numero)
go

 ALTER TABLE tbDetalle
ADD CONSTRAINT FK_detalle_Boletaproducto
FOREIGN KEY (FCodProducto) REFERENCES tbProducto (Codigo)
go

ALTER TABLE tbInventario
ADD CONSTRAINT FK_Inventario_Proveedor
FOREIGN KEY (FCodProveedor) REFERENCES tbProveedor (Codigo)
go
...
FOREIGN KEY (FCodEmpleado) REFERENCES tbEmpleado(Codigo)
go

ALTER TABLE tbBoleta
ADD CONSTRAINT FK_Boleta_Empresa
FOREIGN KEY (FRuc) REFERENCES tbEmpresa (Ruc)
go
...
INSERT [dbo].[tbBoleta] ([Serie], [Numero], [Fecha], [Total], [Estado], [FRuc], [FDniCliente], [FCodigoEmpleado]) VALUES (N'001', N'000001', CAST(N'2018-05-29' AS Date), CAST(50.50 AS Decimal(18, 2)), N'TRUE', N'11111111111', N'00000001', N'10000001')
INSERT [dbo].[tbBoleta] ([Serie], [Numero], [Fecha], [Total], [Estado], [FRuc], [FDniCliente], [FCodigoEmpleado]) VALUES (N'001', N'000002', CAST(N'2018-05-29' AS Date), CAST(31.00 AS Decimal(18, 2)), N'TRUE', N'11111111111', N'00000003', N'10000002')
INSERT [dbo].[tbBoleta] ([Serie], [Numero], [Fecha], [Total], [Estado], [FRuc], [FDniCliente], [FCodigoEmpleado]) VALUES (N'001', N'000003', CAST(N'2018-05-29' AS Date), CAST(15.50 AS Decimal(18, 2)), N'TRUE', N'11111111111', N'00000002', N'10000001')
INSERT [dbo].[tbBoleta] ([Serie], [Numero], [Fecha], [Total], [Estado], [FRuc], [FDniCliente], [FCodigoEmpleado]) VALUES (N'001', N'000004', CAST(N'2018-05-29' AS Date), CAST(80.20 AS Decimal(18, 2)), N'TRUE', N'11111111111', N'00000001', N'10000003')
...
INSERT [dbo].[tbPedido] ([Codigo], [Fecha], [Descripcion], [Total], [FDniCliente], [FCodEmpleado], [Estado]) VALUES (N'101', CAST(N'2018-05-29' AS Date), N'Torta de Novia', CAST(100.00 AS Decimal(18, 2)), N'00000001', N'10000001', N'Completado')
INSERT [dbo].[tbPedido] ([Codigo], [Fecha], [Descripcion], [Total], [FDniCliente], [FCodEmpleado], [Estado]) VALUES (N'102', CAST(N'2018-05-29' AS Date), N'Pan Frances', CAST(7.00 AS Decimal(18, 2)), N'00000002', N'10000001', N'Iniciado')
INSERT [dbo].[tbPedido] ([Codigo], [Fecha], [Descripcion], [Total], [FDniCliente], [FCodEmpleado], [Estado]) VALUES (N'103', CAST(N'2018-05-29' AS Date), N'Pan Integral', CAST(10.50 AS Decimal(18, 2)), N'00000003', N'10000001', N'Procesando')
...
CREATE procedure [dbo].[USP_I_AgregarDetallePedido]
@CodigoDet nvarchar(6),
@FCodPro nvarchar(6),
@CCompraDet int,
@ImporteDet decimal (18,2)
as
begin
insert into tbDetallePedido(Codigo, FCodProducto, CantCompra, Importe)
values (@CodigoDet, @FCodPro, @CCompraDet, @ImporteDet)
end
GO
...
SET QUOTED_IDENTIFIER ON
GO
CREATE Procedure [dbo].[USP_S_ListarDetallePedido]
as 
begin
select * from tbDetallePedido
end 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE Procedure [dbo].[USP_U_ActualizarDetallePedido]
@CodigoDet nvarchar(6),
@FCodPro nvarchar(6),
@CCompraDet int,
@ImporteDet decimal (18,2)
as 
begin
UPDATE tbDetallePedido
set 
Codigo=@CodigoDet,
FCodProducto=@FCodPro,
CantCompra=@CCompraDet,
Importe=@ImporteDet
where 
Codigo=@CodigoDet
end
